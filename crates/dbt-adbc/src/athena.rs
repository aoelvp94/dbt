...
/// with "Unknown database option". Verified against the driver at 2026-09-17
/// HEAD. Keep the Rust constant name (it matches the profile field callers
/// read) and translate at the wire.
